...
function getSdk() {
  ...
  const sdk = {
    ...
    GetTotFileResults: everything.func("Everything_GetTotFileResults", "uint32", []),
    GetTotFolderResults: everything.func("Everything_GetTotFolderResults", "uint32", []),
...
function runQuery(sdk, query, opts, max, sort) {
  ...
  return {
    ...
    total_files: sdk.GetTotFileResults(),
    total_folders: sdk.GetTotFolderResults()
  };
}
    ...
    output: {
      schema: {
        ...
        properties: {
          ...
          total_folders: { type: "integer", required: true },
