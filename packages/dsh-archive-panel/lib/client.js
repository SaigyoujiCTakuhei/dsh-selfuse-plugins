  ...
  factory: (require) => {
    ...
    function apply(ctx) {
      ...
      const unarchive = async (sessionId) => {
        const response = await fetch("/api/dsh-archive/unarchive", {
          method: "POST",
